library('rsconnect')
library(ShinyCellPLUS) #devtools::install_github("bioinformaticsMUSC/ShinyCellPLUS")
library(Seurat)
library(tidyverse)

setwd("/Users/SuganyaSubramanian/Guttridge_Human/")

load("output_Relabel_Negative/12_Negative_FinalShiny.RData")

#https://bioinformatics-musc.shinyapps.io/Pryce-et-al_SingleCell_Human_Cachexia_Negative/

seu_filt <- Neg_Seurat_final
...
makeShinyApp(seu_filt, scConf, gene.mapping = TRUE,
             shiny.title = "Pryce etal SingleCell Human Cachexia Negative",
...
rsconnect::deployApp("shinyApp/",
                     appName = 'Pryce-et-al_SingleCell_Human_Cachexia_Negative', 
