...
#load("output_sct_Integrated/06_SeuratObj_SCT_30pcs_03res_NoDoublet_Reclustered.RData")
...
pdf("output_sct_Integrated/10_UMAP_NoDoublet_res02.pdf", width = 10, height = 6)
...
pdf("output_sct_Integrated/10_UMAP_NoDoublet_res03.pdf", width = 10, height = 6)
...
pdf("output_sct_Integrated/10_UMAP_NoDoublet_res04.pdf", width = 10, height = 6)
...
save(seuObject_slim_nodoub_slim, file = "output_sct_Integrated/07_SeuObject_SCT_30pcs_04res_NoDoublet_slim.RData")
