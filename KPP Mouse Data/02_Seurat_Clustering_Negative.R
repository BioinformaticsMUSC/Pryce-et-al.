...
pdf("output_sct_Integrated/01_Quality_Control_plots_log.pdf", width=6,height=4)
feats <- c("nUMI", "nGene", "pMito")
...
#QC plot 2
pdf("output_sct_Integrated/02_Quality_Control_Scatter.pdf", width=5,height=4)
...
scatter <- seuObject@meta.data %>% 
  ...
  facet_wrap(~Genotype)
ggsave("output_sct_Integrated/03_GeneXUMI.pdf", plot = scatter, width = 6, height = 4, units = "in", dpi = 150)
...
save(integ_anchors, file = "output_sct_Integrated/tmp3.RData")
...
save(seuObject_integrated, file = "output_sct_Integrated/tmp4.RData")
