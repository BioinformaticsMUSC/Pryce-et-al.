...
###2. Load Labels data
Labels <- read.table("Positive/output_sct_Integrated/New_Labels.txt",header=T,sep="\t")
...
save(posSeurat,file = "Positive/output_Relabel/11_FinalRelabel.RData")

pdf("Positive/output_Relabel/01_UMAP_Labelled.pdf", width = 6, height = 7)
DimPlot(object = posSeurat, reduction = "umap", label = TRUE, pt.size = 0.5) + theme(legend.position="none")
dev.off()

pdf("Positive/output_Relabel/02_UMAP_Labelled_Groupby.pdf", width = 12, height = 7)
...
pdf("Positive/output_Relabel/03_UMAP_Labelled_withclusters.pdf", width = 12, height = 7)
Idents(posSeurat) <- "seurat_clusters"
p1 <- DimPlot(object = posSeurat, reduction = "umap", label = TRUE, pt.size = 0.5) + theme(legend.position="none")
...
pdf("Positive/output_Relabel/04_UMAP_Labelled_Splitby_Genotype.pdf", width = 12, height = 7)
...
pdf("Positive/output_Relabel/07_DotPlot_Celltype_Markers.pdf", width = 10, height = 6)
...
pdf("Positive/output_Relabel/05_UMAP_Labelled_Alternative.pdf", width = 8, height = 7)
...
pdf("Positive/output_Relabel/07_DotPlot_Celltype_MarkersGroup.pdf", width = 10, height = 6)
...
pdf("Positive/output_Relabel/08_Barplot_NumberOfCells_Rhox5.pdf", width = 8, height = 10)
...
pdf("Positive/output_Relabel/08_Barplot_NumberOfCells_Rhox5_Hori.pdf", width = 10, height = 6)
ggbarplot(grouped_data, "Cell", "Cells",
          fill = "Genotype", color = "Genotype", palette = color,
...
pdf("Positive/output_Relabel/09_FeaturePlot_NumberOfCells_Rhox5.pdf", width = 8, height = 7)
...
pdf("Positive/output_Relabel/09_FeaturePlot_NumberOfCells_Rhox5_scCustom.pdf", width = 8, height = 7)
FeaturePlot_scCustom(seurat_object = posSeurat, 
                     features = "Rhox5", colors_use = pal,raster = "TRUE")
dev.off()

pdf("Positive/output_Relabel/10_DensityPlot_Rhox5.pdf", width = 8, height = 7)
...
#pdf("Positive/output_Relabel/08_HeatMap_Celltype_Markers.pdf", width = 8, height = 10)
#P2
#dev.off()
...
P2 <- P2 + theme(aspect.ratio = 4/1)
P2 <- P2 + theme(text = element_text(size = 6))
pdf("Positive/output_Relabel/08_HeatMap_Celltype_Markers_top5.pdf", width = 8, height = 15)
P2
dev.off()
