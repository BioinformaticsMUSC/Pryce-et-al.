...
load("Positive/output_sct_Integrated/07_SeuObject_SCT_30pcs_allres_NoDoublet_slim.RData")
...
openxlsx::write.xlsx(all_markers.Sign, 
                     file = "Positive/output_sct_Integrated/Res06_Presto_Filteredmarkers_padjLT05_logfcGT0.xlsx", 
                     colNames = TRUE,
                     rowNames = FALSE, 
                     borders = "columns",
                     sheetName="Markers")