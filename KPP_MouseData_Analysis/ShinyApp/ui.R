...
### Page title 
titlePanel("Pryce etal SingleCell Mouse KPP Positive"),  
navbarPage( 
  NULL,  
...
tabPanel( 
  ...
  br(),br(), 
  fluidRow( 
    selectInput("sc1de_genes_select", "Select differential expression:", choices=strsplit(sc1conf[DEs!=FALSE]$DEs[1], "\\|")[[1]]), # would you ever want to look at all? 
    column(12, 
...
tabPanel( 
  ...
  fluidRow( 
    column(3, style="border-right: 2px solid black", 
      ...
      selectInput("volc_de_select", "Select differential expression:", choices=strsplit(sc1conf[DEs!=FALSE]$DEs[2], "\\|")[[1]]), # would you ever want to look at all? 
      ...
      br(), 
      sliderInput("volc_fold_change", "Fold Change", 0, 6, 1, round=-1, step=0.1), # dynamic max? 
      textInput("volc_p_value", "Adjusted p-Value", placeholder="Enter a numeral value (default is '0.05')") 
    ), 
    column(9, 
