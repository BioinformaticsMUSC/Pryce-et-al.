...
load("Positive/output_Relabel/12_Negative_FinalShiny.RData")

seu_filt <- posSeurat_final
...
makeShinyApp(seu_filt, scConf, gene.mapping = TRUE,
             shiny.title = "Pryce etal SingleCell Mouse KPP Positive",
...
rsconnect::deployApp("shinyApp/",
                     appName = 'Pryce-et-al_SingleCell_Mouse_KPP_Positive', 
